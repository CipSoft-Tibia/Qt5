...
void GlobalEnumGadget::registerTypes()
{
    ...
    qRegisterMetaType<MyTopLevelNamespace::qt::protobuf::GlobalEnumGadget::GlobalEnum>();
    qRegisterProtobufEnumType<MyTopLevelNamespace::qt::protobuf::GlobalEnumGadget::GlobalEnum>();
}
