...
CONSTINIT const base::Feature kMediaSessionService(
             "MediaSessionService",
...
CONSTINIT const base::Feature kAudioFocusEnforcement(
...
CONSTINIT const base::Feature kAudioFocusSessionGrouping(
