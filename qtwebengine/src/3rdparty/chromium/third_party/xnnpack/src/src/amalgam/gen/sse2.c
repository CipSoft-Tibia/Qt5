...
void xnn_f16_vabs_ukernel__sse2_u16(
    ...
    const void* input,
    void* output,
    const union xnn_f16_abs_params params[XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  assert(batch != 0);
  assert(batch % sizeof(uint16_t) == 0);
  assert(input != NULL);
...
void xnn_f16_vneg_ukernel__sse2_u16(
    ...
    const void* input,
    void* output,
    const union xnn_f16_neg_params params[XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  assert(batch != 0);
  assert(batch % sizeof(uint16_t) == 0);
  assert(input != NULL);
...
void xnn_f32_f16_vcvt_ukernel__sse2_u16(
    ...
    const float* input,
    void* output,
    const union xnn_f32_f16_cvt_params params[XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  assert(batch != 0);
...
void xnn_f32_qs8_vcvt_ukernel__sse2_u32(
    ...
    const float* input,
    int8_t* output,
    const union xnn_f32_qs8_cvt_params params[XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  assert(batch != 0);
  assert(batch % sizeof(float) == 0);
  assert(input != NULL);
...
void xnn_f32_qu8_vcvt_ukernel__sse2_u32(
    ...
    const float* input,
    uint8_t* output,
    const union xnn_f32_qu8_cvt_params params[XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  assert(batch != 0);
  assert(batch % sizeof(float) == 0);
  assert(input != NULL);
...
void xnn_f32_raddstoreexpminusmax_ukernel__sse2_rr2_p5_u20_acc2(
    ...
    float* output,
    float* sum,
    const union xnn_f32_expminus_params params[XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  assert(batch != 0);
  assert(batch % sizeof(float) == 0);
  assert(input != NULL);
...
void xnn_f32_velu_ukernel__sse2_rr2_lut16_p3_u12(
    ...
    const float* input,
    float* output,
    const union xnn_f32_elu_params params[XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  assert(batch != 0);
  assert(batch % sizeof(float) == 0);
  assert(input != NULL);
...
void xnn_f32_vrndd_ukernel__sse2_u8(
    ...
    const float* input,
    float* output,
    const union xnn_f32_rnd_params params[XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  assert(batch != 0);
  assert(batch % sizeof(float) == 0);
  assert(input != NULL);
...
void xnn_f32_vsigmoid_ukernel__sse2_rr2_lut64_p2_div_u8(
    ...
    const float* input,
    float* output,
    const union xnn_f32_sigmoid_params params[XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  assert(batch != 0);
  assert(batch % sizeof(float) == 0);
  assert(input != NULL);
...
void xnn_qd8_f32_qb4w_gemm_minmax_ukernel_1x4c8__sse2_ld128(
    ...
    size_t cm_stride,
    size_t cn_stride,
    const union xnn_f32_qb4w_minmax_params params[XNN_MIN_ELEMENTS(1)],
...
void xnn_qs16_qs8_vcvt_ukernel__sse2_u16(
    ...
    const int16_t* input,
    int8_t* output,
    const union xnn_qs16_qs8_cvt_params params[XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  assert(batch != 0);
...
void xnn_qs8_dwconv_minmax_fp32_ukernel_25p8c__sse2_mul16_add16(
    ...
    size_t input_offset,
    const int8_t* zero,
    const union xnn_qs8_conv_minmax_params params[XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  assert(channels != 0);
...
void xnn_qs8_f32_vcvt_ukernel__sse2_u32(
    ...
    const int8_t* input,
    float* output,
    const union xnn_qs8_f32_cvt_params params[XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  assert(batch != 0);
...
void xnn_qs8_gavgpool_minmax_fp32_ukernel_7p7x__sse2_c8(
    ...
    int32_t* buffer,
    int8_t* output,
    const union xnn_qs8_avgpool_minmax_params params[XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  assert(rows > 7);
  assert(channels != 0);
...
void xnn_qs8_qc8w_dwconv_minmax_fp32_ukernel_25p8c__sse2_mul16(
    ...
    size_t input_offset,
    const int8_t* zero,
    const union xnn_qs8_qc8w_conv_minmax_params params[XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  assert(channels != 0);
  assert(output_width != 0);
...
void xnn_qs8_vadd_minmax_ukernel__sse2_mul16_ld64_u8(
    ...
    int8_t* output,
    const union xnn_qs8_add_minmax_params params[XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  assert(batch != 0);
  assert(batch % sizeof(int8_t) == 0);
  assert(input_a != NULL);
...
void xnn_qs8_vcvt_ukernel__sse2_u32(
    ...
    const int8_t* input,
    int8_t* output,
    const union xnn_qs8_cvt_params params[XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  assert(batch != 0);
  assert(batch % sizeof(int8_t) == 0);
  assert(input != NULL);
...
void xnn_qs8_vlrelu_ukernel__sse2_u32(
    ...
    const int8_t* input,
    int8_t* output,
    const union xnn_qs8_lrelu_params params[XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  assert(batch != 0);
  assert(batch % sizeof(int8_t) == 0);
  assert(input != NULL);
...
void xnn_qs8_vmul_minmax_fp32_ukernel__sse2_mul16_ld64_u8(
    ...
    const int8_t* input_b,
    int8_t* output,
    const union xnn_qs8_mul_minmax_params params[XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  assert(batch != 0);
  assert(batch % sizeof(int8_t) == 0);
  assert(input_a != NULL);
...
void xnn_qu8_avgpool_minmax_fp32_ukernel_9p8x__sse2_c8(
    ...
    size_t input_increment,
    size_t output_increment,
    const union xnn_qu8_avgpool_minmax_params params[XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  assert(output_pixels != 0);
...
void xnn_qu8_dwconv_minmax_fp32_ukernel_25p8c__sse2_mul16(
    ...
    size_t input_offset,
    const uint8_t* zero,
    const union xnn_qu8_conv_minmax_params params[XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  assert(channels != 0);
  assert(output_width != 0);
...
void xnn_qu8_f32_vcvt_ukernel__sse2_u32(
    ...
    const uint8_t* input,
    float* output,
    const union xnn_qu8_f32_cvt_params params[XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  assert(batch != 0);
...
void xnn_qu8_vadd_minmax_ukernel__sse2_mul16_ld64_u8(
    ...
    uint8_t* output,
    const union xnn_qu8_add_minmax_params params[XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  assert(batch != 0);
  assert(batch % sizeof(uint8_t) == 0);
  assert(input_a != NULL);
...
void xnn_qu8_vcvt_ukernel__sse2_u32(
    ...
    const uint8_t* input,
    uint8_t* output,
    const union xnn_qu8_cvt_params params[XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  assert(batch != 0);
  assert(batch % sizeof(uint8_t) == 0);
  assert(input != NULL);
...
void xnn_qu8_vlrelu_ukernel__sse2_u32(
    ...
    const uint8_t* input,
    uint8_t* output,
    const union xnn_qu8_lrelu_params params[XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  assert(batch != 0);
  assert(batch % sizeof(uint8_t) == 0);
  assert(input != NULL);
...
void xnn_qu8_vmul_minmax_fp32_ukernel__sse2_mul16_ld64_u8(
    ...
    const uint8_t* input_b,
    uint8_t* output,
    const union xnn_qu8_mul_minmax_params params[XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  assert(batch != 0);
  assert(batch % sizeof(uint8_t) == 0);
  assert(input_a != NULL);
...
void xnn_s8_maxpool_minmax_ukernel_9p8x__sse2_c16(
    ...
    size_t input_increment,
    size_t output_increment,
    const union xnn_s8_minmax_params params[XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  assert(output_pixels != 0);
  assert(kernel_elements != 0);
  assert(channels != 0);
...
void xnn_u8_maxpool_minmax_ukernel_9p8x__sse2_c16(
    ...
    size_t input_increment,
    size_t output_increment,
    const union xnn_u8_minmax_params params[XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  assert(output_pixels != 0);
  assert(kernel_elements != 0);
  assert(channels != 0);
...
void xnn_f32_vcopysign_ukernel__sse2_u8(
    ...
    const float* sign,
    float* output,
    const union xnn_f32_default_params unused_params[XNN_MIN_ELEMENTS(1)])
{
  assert(batch != 0);
  assert(batch % sizeof(float) == 0);
  assert(mag != NULL);
...
void xnn_f32_vtanh_ukernel__sse2_rational_9_6_div_u8(
    ...
    const float* input,
    float* output,
    const union xnn_f32_tanh_params unused_params[XNN_MIN_ELEMENTS(1)])
{
  assert(batch != 0);
  assert(batch % sizeof(float) == 0);
  assert(input != NULL);
