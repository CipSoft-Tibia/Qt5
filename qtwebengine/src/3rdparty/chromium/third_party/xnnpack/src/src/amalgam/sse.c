...
void xnn_f32_avgpool_minmax_ukernel_9p8x__sse_c4(
    ...
    const union xnn_f32_scaleminmax_params params[XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
...
void xnn_f32_dwconv2d_chw_ukernel_3x3p1__sse_2x4_acc2(
    ...
    const union xnn_f32_chw_params params[XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
...
void xnn_f32_gavgpool_cw_ukernel__sse_x4(
    ...
    const float* input,
    float* output,
    const union xnn_f32_gavgpool_params params[XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  assert(elements != 0);
...
void xnn_f32_vmax_ukernel__sse_x8(
    ...
    const float* input_b,
    float* output,
    const union xnn_f32_default_params params[XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  assert(batch != 0);
  assert(batch % sizeof(float) == 0);
  assert(input_a != NULL);
...
void xnn_f32_vhswish_ukernel__sse_x8(
    ...
    const float* input,
    float* output,
    const union xnn_f32_hswish_params params[XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  assert(batch != 0);
  assert(batch % sizeof(float) == 0);
  assert(input != NULL);
...
void xnn_f32_vsqrt_ukernel__sse_sqrt_x4(
    ...
    const float* input,
    float* output,
    const union xnn_f32_sqrt_params params[XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  assert(batch != 0);
  assert(batch % sizeof(float) == 0);
  assert(input != NULL);
...
void xnn_f32_vabs_ukernel__sse_x8(
    ...
    const float* input,
    float* output,
    const union xnn_f32_abs_params params[XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  assert(batch != 0);
  assert(batch % sizeof(float) == 0);
  assert(input != NULL);
...
void xnn_f32_vneg_ukernel__sse_x8(
    ...
    const float* input,
    float* output,
    const union xnn_f32_neg_params params[XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  assert(batch != 0);
  assert(batch % sizeof(float) == 0);
  assert(input != NULL);
