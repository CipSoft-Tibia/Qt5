...
void xnn_qc8_dwconv_minmax_fp32_ukernel_25p32c__avx512skx_mul32(
    ...
    size_t input_offset,
    const int8_t* zero,
    const union xnn_qc8_conv_minmax_params params[ XNN_MIN_ELEMENTS(1)]) XNN_DISABLE_MSAN
{
  assert(channels != 0);
...
void xnn_qs8_dwconv_minmax_fp32_ukernel_25p32c__avx512skx_mul32(
    ...
    size_t input_offset,
    const int8_t* zero,
    const union xnn_qs8_conv_minmax_params params[XNN_MIN_ELEMENTS(1)]) XNN_DISABLE_MSAN
{
  assert(channels != 0);
  assert(output_width != 0);
...
void xnn_qu8_dwconv_minmax_fp32_ukernel_25p32c__avx512skx_mul32(
    ...
    size_t input_offset,
    const uint8_t* zero,
    const union xnn_qu8_conv_minmax_params params[ XNN_MIN_ELEMENTS(1)]) XNN_DISABLE_MSAN
{
  assert(channels != 0);
  assert(output_width != 0);
