...
void xnn_f16_raddstoreexpminusmax_ukernel__avx2_rr1_p2_u40(
    ...
    void* output,
    void* sum,
    const union xnn_f16_expminus_params params[XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  assert(batch != 0);
...
void xnn_f16_velu_ukernel__avx2_rr1_p3_u16(
    ...
    const void* input,
    void* output,
    const union xnn_f16_elu_params params[XNN_MIN_ELEMENTS(1)])
{
  assert(batch != 0);
  assert(batch % sizeof(uint16_t) == 0);
  assert(input != NULL);
...
void xnn_f16_vsigmoid_ukernel__avx2_rr1_p2_rcp_u32(
    ...
    const void* input,
    void* output,
    const union xnn_f16_sigmoid_params params[XNN_MIN_ELEMENTS(1)])
{
  assert(batch != 0);
  assert(batch % sizeof(uint16_t) == 0);
  assert(input != NULL);
...
void xnn_qs8_f16_vcvt_ukernel__avx2_u16(
    ...
    const int8_t* input,
    void* output,
    const union xnn_qs8_f16_cvt_params params[XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  assert(batch != 0);
