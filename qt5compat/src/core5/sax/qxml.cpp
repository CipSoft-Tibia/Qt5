...
/*!
    ...
    \l {http://www.saxproject.org/}{SAX2 Java interface}, with
...
/*
  ...
  The character(s) which the reference mapped to are inserted at the reference
...
/*
  ...
  with reading only whitespace characters. In this case it also populates the
