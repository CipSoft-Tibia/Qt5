 ...
 */
Q_CORE5COMPAT_EXPORT QString qt_regexp_toCanonical(const QString &pattern,
                                                   QRegExp::PatternSyntax patternSyntax)
{
...
/*!
  \fn QString QRegExp::removeIn(const QString &str) const
...
/*!
  \fn QString QRegExp::countIn(const QString &str) const
...
/*!
    Returns a list of all the strings that match this regular
    expression in \a stringList.
*/
...
/*!
    Replaces every occurrence of this regexp, in each of \a stringList's
